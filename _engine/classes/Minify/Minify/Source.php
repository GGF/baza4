...
class Minify_Source {
    ...
    public function getContent()
    {
        $content = (null !== $this->filepath)
            ? $this->filegetcontent($this->filepath) //file_get_contents($this->filepath)
            : ((null !== $this->_content)
                ? $this->_content
    ...
    private function filegetcontent($filename) {
        if (stristr($filename,'.js.php') || stristr($filename,'.css.php')) {
            ob_start();
            include $filename;
            return ob_get_clean();
        } else {
