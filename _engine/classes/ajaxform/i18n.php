...
Lang::add(array("Form" => array(
	...
	"error" => array(
		...
		"checker" => array(
			...
			AJAXFORM_CHECK_DEFAULT => array(
				"ru" => "",
				"en" => "",
			),
			
			AJAXFORM_CHECK_CUSTOM => array(
				"ru" => "",
				"en" => "",
			),
			
			AJAXFORM_CHECK_NUMERIC => array(
				"ru" => "Это поле может содержать только цифры", 
				"en" => "Allowed characters: digits only",
			),
			
			AJAXFORM_CHECK_LOGIN => array(
				"ru" => "", 
				"en" => "",
			),
			
			AJAXFORM_CHECK_CODE => array(
				"ru" => "",
				"en" => "",
			),
			
			AJAXFORM_CHECK_PHONE => array(
				"ru" => "",
				"en" => "",
			),
			
			AJAXFORM_CHECK_MAIL => array(
				"ru" => "",
				"en" => "",
			),
			
			AJAXFORM_CHECK_URL => array(
				"ru" => "", 
				"en" => "",
			),
